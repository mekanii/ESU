...
```math
Clock Divider = \frac{\text{APB_CLK}APB_CLK}{\text{Clock Frequency}} = \frac{80\text{ MHz}}{80\text{ MHz}} = 1
```
##### Resolution
...
```math
Resolution = \frac{\text{Clock Frequency}}{\text{PWM Frequency}} = \frac{80\text{ MHz}}{400\text{ MHz}} = 200
```
